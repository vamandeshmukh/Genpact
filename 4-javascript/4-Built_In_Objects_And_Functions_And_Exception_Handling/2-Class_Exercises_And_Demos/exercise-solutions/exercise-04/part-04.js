...
// includes only number of projects
console.log(employees.map(function( emp ) {
    return emp.projects.length;
}));

// you can also include the name of the employee by creating objects as items in the array
console.log(employees.map(function( emp ) {
    return {
        name: emp.name,
        numberOfProjects: emp.projects.length
    };
}));